...
const FilterPCard = () => {
  ...
  const [totalExpenseClaim, setTotalExpenseClaim] = useState('');
  const [vendorName, setVendorName] = useState('');
  const [mineralOrGeothermal, setMineralOrGeothermal] = useState('');
  const [companyToPay, setCompanyToPay] = useState('');
  ...
  const formData = [
    ...
    },
    {
      ...
      placeholder: 'Total Expense Claim',
      value: totalExpenseClaim,
      onChangeText: setTotalExpenseClaim,
      type: "text",
    },
    {
      label: 'Vendor Name',
