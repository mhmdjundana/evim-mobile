...
import DocumentDetailNew from "./bast/DocumentDetail";
import DocumentDetailBastSapEditFilesNew from "./bast/DocumentDetailFiles";
import DetailTableNew from "./bast/DetailTable";
